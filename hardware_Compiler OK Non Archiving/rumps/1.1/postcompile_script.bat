...
set param_filename=%~dsp0rumps_compile_param.txt
set counter_filename=%~dsp0rumps_runlog.txt
set timer_filename=%~dsp0rumps_exectime.txt
...
if exist "%counter_filename%" (
    ...
    echo Coba !ide.build.path!\!source.name!
    copy "!ide.build.path!\!source.name!.bin" "!runtime.platform.path!\main!core_count!.bin"
