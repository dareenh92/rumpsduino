...

{
  ...
  TM_PR = 0x63f; // prescale target, 5kHz
  ...
  codeword[0] = 1;
  for(int i=760; i<767; i++){
    codeword[i-760 + 1] = codeword[i] = 0;
  }
  codeword[767] = 1;

  // *** Main Loop - Turbo coding part ***
  while(1){
    while(txd_ready==1); // wait while tx in progress
...
void init_pulseshaping(){
  // set LUT
  // ** bit 0
  rcos_lut[0][0] = rcos_lut[0][20] = 0;
  rcos_lut[0][1] = rcos_lut[0][19] = 45;
  rcos_lut[0][2] = rcos_lut[0][18] = 100;
  rcos_lut[0][3] = rcos_lut[0][17] = 135;
  rcos_lut[0][4] = rcos_lut[0][16] = 112;
  rcos_lut[0][5] = rcos_lut[0][15] = 0;
  rcos_lut[0][6] = rcos_lut[0][14] = -206; 
  rcos_lut[0][7] = rcos_lut[0][13] = -475;
  rcos_lut[0][8] = rcos_lut[0][12] = -746;
  rcos_lut[0][9] = rcos_lut[0][11] = -949;
  rcos_lut[0][10] = -1024;

  // ** bit 1
  rcos_lut[1][0] = rcos_lut[1][20] = 0;
  rcos_lut[1][1] = rcos_lut[1][19] = -45;
  rcos_lut[1][2] = rcos_lut[1][18] = -100;
  rcos_lut[1][3] = rcos_lut[1][17] = -135;
  rcos_lut[1][4] = rcos_lut[1][16] = -112;
  rcos_lut[1][5] = rcos_lut[1][15] = 0;
  rcos_lut[1][6] = rcos_lut[1][14] = 206; 
  rcos_lut[1][7] = rcos_lut[1][13] = 475;
  rcos_lut[1][8] = rcos_lut[1][12] = 746;
  rcos_lut[1][9] = rcos_lut[1][11] = 949;
  rcos_lut[1][10] = 1024;

  // dummy guard band
  rcos_lut[0][21] = rcos_lut[0][22] = 0;
  rcos_lut[0][23] = rcos_lut[0][24] = 0;

  rcos_lut[1][21] = rcos_lut[1][22] = 0;
  rcos_lut[1][23] = rcos_lut[1][24] = 0;
