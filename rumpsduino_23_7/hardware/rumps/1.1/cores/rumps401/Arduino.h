...
#define GPIO_OEN_SET            ((*(volatile unsigned long *) (0x50000008))) // Output enable control (output)
#define GPIO_OEN_CLR            ((*(volatile unsigned long *) (0x5000000C))) // Output enable control (input)
...
#define MUXC_SELECT        ((*(volatile unsigned long *) (0x50010000)))
#define MUXC_PU            ((*(volatile unsigned long *) (0x50010004)))

#define __NOP() __asm__("nop\n\t")// DELAY
#define __DEL() __asm__("push {r0}\n movs  r0, #1\n lop: sub  r0, r0, #1\n cmp r0, #0\n bne  lop\n pop {r0}")// DELAY
